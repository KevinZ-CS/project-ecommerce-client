        ...
        <footer className={`${FooterCSS.footerBg} py-5`}>
            ...
            <Container>
                ...
                <div className="input-group">
                    <input type="text" className={`form-control rounded-0 ${FooterCSS.footerInput}`} placeholder="email@example.com"/>
                    <button className={`btn btn-dark btn-sm col-md-3 rounded-0 ${FooterCSS.button}`} type="submit">
